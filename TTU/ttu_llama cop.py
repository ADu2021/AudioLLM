...
def main():
    ...
    run_name = f"{current_time}-LLaMA{if_only_first_seperated}{if_resample}{weight_sep}-NGPU-{GPU_COUNT}_BS-{BATCH_SIZE}_LR-{LR}-Warmup-{WARMUP_STEPS}-EPOCH-{EPOCHS}-EMBED-{EMBED_DIM}-FFN-{FFN_DIM}-DR-{DROPOUT}-NH-{NUM_HEADS}-NL-{NUM_LAYERS}{src_mask_type}{tgt_mask_type}{memory_mask_type}"
