...
def job(gpu_id: int, x: int):
    from train_forced_aligner import inference
...
def get_log_file(x):
    return f"/afs/cs.stanford.edu/u/duyy/data/AudioLLM/Alignment/result/logs-mls/chunk_{x}.log"
...
def distribute():
    ...
    parser.add_argument("--end-chunk", type=int, default=4096) # exclusive
